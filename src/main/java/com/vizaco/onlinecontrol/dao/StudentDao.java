...
/**
 * DAO class for <code>Student</code> domain objects All method names are compliant with Spring Data naming
...
public interface StudentDao {
    ...
    void save(Student owner) throws DataAccessException;
