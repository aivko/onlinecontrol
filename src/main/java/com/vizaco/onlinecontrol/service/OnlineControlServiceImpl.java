 ...
 */
@Service
public class OnlineControlServiceImpl implements OnlineControlService {

    private StudentDao studentDao;

    public OnlineControlServiceImpl() {
    }

    @Autowired
    public OnlineControlServiceImpl(StudentDao studentDao) {
